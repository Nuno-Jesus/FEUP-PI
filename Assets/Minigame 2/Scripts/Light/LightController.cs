...
public class LightController : MonoBehaviour
{
    ...
    public int paintCurrentFrame = 3;
    ...
    void Start()
    {
        ...
        lightRanges[0] = new KeyValuePair<float, float>(20.0f, 34.99f);
        lightRanges[1] = new KeyValuePair<float, float>(35.0f, 49.99f);
        lightRanges[2] = new KeyValuePair<float, float>(50.0f, 149.99f);
        lightRanges[3] = new KeyValuePair<float, float>(150.0f, 324.99f);
        lightRanges[4] = new KeyValuePair<float, float>(325.0f, 500.0f);

		lightSlider.value = 250.0f;
    }
